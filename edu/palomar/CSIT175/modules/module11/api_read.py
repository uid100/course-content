...
# try this URL in a browser. Refresh the page a couple of times. What happened?
URL = "https://api.quotable.io/random"
SUCCESS_STATUS = 200


# returns a tuple with a quote and author
def get_random_quote():
    ...
    if response.status_code == SUCCESS_STATUS:
        # JSON text format is similar to Python dictionaries
        data = response.json()
