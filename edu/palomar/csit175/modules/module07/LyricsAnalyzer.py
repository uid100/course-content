...
# LyricsAnalyzer - read text file and count occurrence of strings
...
# find number of occurrences of each string in the input list
def get_counts(word_list):
    ...
    # just for fun, let's return a tuple.
